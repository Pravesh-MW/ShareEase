    ...
    <div className="w-full max-w-sm">
      ...
      <div className="flex items-center">
        ...
        <button
          ...
          className="flex-shrink-0 z-10 inline-flex items-center py-3 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-e-lg hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 border border-blue-700 dark:border-blue-600 hover:border-blue-800 dark:hover:border-blue-700"
          type="button"
