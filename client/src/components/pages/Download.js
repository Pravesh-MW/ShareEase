    ...
    <div className="flex w-full h-2/3 justify-center items-center pt-20">
      <div className="flex justify-center items-center bg-orange-200 flex-col space-y-10 p-24 rounded-lg">
        ...
        <input
          ...
          className="mb-6 bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400"
